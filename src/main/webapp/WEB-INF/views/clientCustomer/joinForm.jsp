				...
				$("#customerJoinBtn").click(function(){
					...
					if(!$("#agree2").is(":checked")){
						...
						$.ajax({
							...
							type:"post",
							data:$("#loginForm").serialize(), // "c_id="+$("#c_id").val(), //
							dataType:"text",
							errer:function(){
							...
							success:function(resultData){
								...
								if(resultData==1){
									$("#msg").text("이미 존재하는 아이디 입니다.").css("color","red");
									$("#c_id").focus();
								}else if(resultData==0){
									
									$("#loginForm").attr({
										"method":"post",
										"action":"/customer/customerInsert"
									});
									$("#loginForm").submit();
								}
							} 
			...
			<div class="contact-section">
				<div class="container">
                    ...
                    <form  id="loginForm" class="contact-form">
                        <div class="row">
                            <div class="col-lg-12">
                                <input type="text" id="c_id" name="c_id" placeholder="아이디">                       
                                ...
                                <span id="msg"></span>
                           		<input type="text" id="c_name" name="c_name" placeholder="이름"  />
								<input type="text" id="c_phone" name="c_phone" placeholder="전화번호"  />
							</div>
							<div class="col-lg-6">	
								<input type="text" id="c_address1" placeholder="우편번호" >
							</div>	
							<div class="col-lg-6">
								<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">
							</div>
							<div class="col-lg-12">	
								<input type="text" id="c_address2" placeholder="주소"   >
								<input type="text" id="c_address3" placeholder="상세주소"  >
								<input type="text" id="c_address4" placeholder="참고항목"   >
							...
							<div class="col-lg-12">
                                <textarea class="form-control"  rows="10" >제1조(목적)
이 약관은 AwesomeLeather 회사(전자상거래 사업자)가 운영하는 AwesomeLeather 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리의무 및 책임사항을 규정함을 목적으로 합니다.

※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
①“몰” 이란 hevitz 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
③제공된 개인정보는 당해 이용자의 동의없이 목적외의 이용이나 제3자에게 제공할 수 없으며, 이에 대한 모든 책임은 　hevitz몰　이 집니다. 다만, 다음의 경우에는 예외로 합니다.
...
부 칙(시행일) 이 약관은 2009년 10월 19일부터 시행합니다.</textarea>
			</div>
			 <div class="checkbox col-lg-12">
    			<label>
      			이용약관에 동의하십니까?<input type="checkbox" id="agree1"> 
    			</label>
    		</div>
						<div class="col-lg-12">
						<textarea class="form-control"  rows="10" >주식회사 AwesomeLeather는 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
...
마케팅(광고성) 이메일 및 문자 수신 동의 여부는 회원가입 페이지에서 선택하실 수 있으며, 회원 정보 페이지에서 수정이 가능합니다.
...
o 위탁 대상자 : 우체국택배
o 위탁업무 내용 : 물품 배송시 필요한 필수 정보(이름, 전화번호, 주소)

o 위탁 대상자 : 이니시스
o 위탁업무 내용 : 결제 정보

o 위탁 대상자 : #supply_list#
o 위탁업무 내용 : [위탁업무 내용]
...
경찰청 사이버안전국 (cyberbureau.police.go.kr / 국번없이 182)</textarea>
					 ...
					 <div class="checkbox col-lg-12">
    					<label>
      					개인정보 수집 및 이용에 동의하십니까?<input type="checkbox" id="agree2"> 
    					</label>
    				</div>
					
                            <div class="col-lg-12 text-right">
                                <input type="button" value="회원가입" id="customerJoinBtn" />
					<input type="button" value="회원가입취소" id="customerCancleBtn" />
                            </div>
                        </div>
                    </form>
                </div>
			...
			<!-- <div>
				<form id="loginForm">
					<input type="text" id="c_id" name="c_id" placeholder="아이디" class="form-control"  /><br />
					<input type="button" value="인증메일" id="mailCheckBtn" /><br />
					<input type="password" id="c_pw" name="c_pw" placeholder="비밀번호" class="form-control" /><br />
					<input type="password" id="c_pwcheck"  placeholder="비밀번호확인"  class="form-control" /><span id="msg"></span><br />
					<input type="text" id="c_name" name="c_name" placeholder="이름" class="form-control"  /><br />
					<input type="text" id="c_phone" name="c_phone" placeholder="전화번호" class="form-control"  /><br />
					<input type="text" id="c_address1" placeholder="우편번호" >
					<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
					<input type="text" id="c_address2" placeholder="주소" class="form-control"  ><br>
					<input type="text" id="c_address3" placeholder="상세주소" class="form-control"  >
					<input type="text" id="c_address4" placeholder="참고항목" class="form-control"  >
					<input type="hidden" id="c_address" name="c_address" /><br />
					<span>
						<label>이메일 수신여부</label>
						<input type="checkbox" id="c_echeck" name="c_echeck"/>
					</span><br />
					<div>
						<textarea class="form-control"  rows="10" >제1조(목적)
이 약관은 hevitz 회사(전자상거래 사업자)가 운영하는 hevitz 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리의무 및 책임사항을 규정함을 목적으로 합니다.
...
부 칙(시행일) 이 약관은 2009년 10월 19일부터 시행합니다.</textarea><br/>
						<label>이용약관에 동의하십니까?</label>
						<input type="checkbox" id="agree1" />
					</div><br />
					<div>
					
						<textarea class="form-control"  rows="10" >주식회사 헤비츠는 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
회사는 개인정보처리방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
...
개인정보분쟁조정위원회 (kopico.go.kr / 1833-6972)
대검찰청 사이버수사과 (spo.go.kr / 지역번호+1301)
경찰청 사이버안전국 (cyberbureau.police.go.kr / 국번없이 182)</textarea><br />
						<label>개인정보 수집 및 이용에 동의하십니까?</label>
						<input type="checkbox" id="agree2" />
					</div><br />
					<input type="button" value="회원가입" id="customerJoinBtn" /><br />
					<input type="button" value="회원가입취소" id="customerCancleBtn" /><br />
				</form>
			</div> -->
